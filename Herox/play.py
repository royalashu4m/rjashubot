...
async def play(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(
                  [[
                      ...
                      InlineKeyboardButton("• Cʜᴀɴɴᴇʟ", url=f"https://t.me/LittelStar_org"),
                      InlineKeyboardButton("• Group", url=f"https://t.me/LittelStar_org"),
                  ],[
    ...
    if replied:
        ...
        if len(m.command) < 2:
         await m.reply_photo(
                    ...
                    [
                        [
                            InlineKeyboardButton("~ Channel ~", url=f"https://t.me/LittelStar_org"),
                            InlineKeyboardButton("~ Support ~", url=f"https://t.me/LittelStar_org")
                        ],
                        [
                            InlineKeyboardButton("🗑 Close", callback_data="cls")
                        ]
